...
#'
#' @description EDIT You can copy directly from the 'Description:'' field in the DESCRIPTION file.
#'
#' @docType package
#' @name radjust
NULL
...
#' }
#'
#' @source \url{} <- EDIT optional, Do we have an online source of the data?
...
#' @description EDIT ...
#'
#' @format A data frame with 3 rows and 12X columns:
#' \tabular{lll}{
